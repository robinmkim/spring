...
<div class="d-flex flex-row-reverse mybgColor">
  ...
  <%-- 로그인 후 --%>
	      <div class="p-2 bg-warning">
		  <a href="${cPath }/login/logout" class="nav-link text-white" id="item2">log out</a>
		  </div>
		  <div class="p-2 bg-primary">
...
<div id="demo" class="carousel slide" data-bs-ride="carousel">
  <!-- Indicators/dots -->
			...
			<c:choose>
				<c:when test="${sessionScope.sessionID == null }">
					<c:set var="carouselMsg"
						value="jQuery 를 이용하여 제공받은 샘플파일에서 아래 요구사항대로 구현합니다."/>
				</c:when>
				<c:otherwise>
					<c:set var="carouselMsg"
						value="${sessionScope.sessionName}님 좋은 하루 입니다."/>
				</c:otherwise>
			</c:choose>
	...
	<nav class="navbar navbar-expand-sm mybgColor">
		<div class="container-fluid">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a href="fboard" class="nav-link">Board</a></li>
				<li class="nav-item"><a href="ajaxBoard" class="nav-link">AjaxBoard</a></li>
				<li class="nav-item"><a href="upList" class="nav-link">UpList</a></li>
