		...
		where num=?
		 --%>
			<form method="post" action="upboardUpdate" autocomplete="off"
				...
				<c:forEach var="e" items="${vo.imgName}">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<img src="${rPath}/imgfile/${e}" id="imgx"
								style="width: 210px; border: dotted 1px; margin: 5px 5px">
						</div>
						<button type="button" onclick="location='imgdelete?num=${vo.num}&iname=${e}'">삭제</button>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<video muted autoplay loop>
							<source src="${rPath}/videofile/${vo.videoName}" type="video/mp4">
						</video>
					</div>
				</div>
